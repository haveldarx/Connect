...
class UserData {
  ...
  getAll() async {
    ...
    return [prefs.getString('uid'),prefs.getString('country'),prefs.getString('locality'),prefs.getString('email'),prefs.getString('phone')];
  }
  ...
  getRememberMe() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return [prefs.getString('rememberMeEmail'), prefs.getString('rememberMePassword')];
  }
